...
let result11 = Math.floor(Math.random() * (10 - 1 + 1)) + 1;
let result2 = Math.floor(Math.random() * (10 - 1 + 1)) + 1;
let result3 = Math.floor(Math.random() * (10 - 1 + 1)) + 1;
let max1 = Math.max(result11, result2, result3); 
let min1 = Math.min(result11, result2, result3);
