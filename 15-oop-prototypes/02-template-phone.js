...
Phone.prototype.call = function () {    .. кожен з них має доступ до цього методу
  console.log(`${this.brand} is calling!`);   те що робить цей метод  oщоразу буде різний метод
}
...
phone2.call();   ...    
console.log(phone2.text());   ... так як це RETURN ми зберегли  ... цей самсунг телефон пише

phone1.connectCarPlay();
phone2.connectCarPlay();     //// ERROR IT'S NOT A FUNCT
